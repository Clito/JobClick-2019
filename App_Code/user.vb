...
Public Class user
    ...
    Public Function validaUtilizador(ByVal sU As String, ByVal sP As String, ByVal sE As String) As Boolean
        ...
        sSQL = "SELECT idUser, userName, password, email, bloquear, grupo, url FROM vwuser WHERE (userName = '" + sUser + "') AND (password = '" + sPwd + "') AND (email='" + sEml + "')"
    ...
    Function idUser(ByVal sU As String, ByVal sP As String, ByVal sE As String) As String
    ...
    Function Contador(ByVal idUser As Integer) As String
    ...
    Function ZoyaID(ByVal idCadastroUser As Integer) As String
    ...
    Function ZoyaIDCV(ByVal idCadastroUser As Integer) As String
    ...
    Public Function GetEMAIL(ByVal id As String) As String
        ...
        sSQL = "SELECT tbUser.idUser, tbUser.userName, tbUser.[password], tbUser.email, tbUser.bloquear FROM tbUser INNER JOIN tbCadastroEmpresa ON tbUser.idUser = tbCadastroEmpresa.idUser WHERE (tbCadastroEmpresa.idCadastroEmpresa=" + id + ")"
