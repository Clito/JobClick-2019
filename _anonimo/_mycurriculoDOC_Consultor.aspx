<%@ Page Language="VB" MasterPageFile="~/_anonimo/CurriculoPageWORD.master" AutoEventWireup="true" CodeFile="_mycurriculoDOC_Consultor.aspx.vb" Inherits="_candidato_mycurriculoDOC" title="Untitled Page" %>
                                    ...
                                    <td width="439">
                                        <asp:DataList ID="DataList1" runat="server" DataKeyField="idCadastroUser" DataSourceID="SqlDataSource1" Width="420px">
                                            <ItemTemplate>
                                                ...
                                                <br />
                                                <asp:Label ID="Labelemail" runat="server" CssClass="cur01st" Text="e-mail:"></asp:Label>
                                                ...
                                                <br />
                                                <asp:Label ID="foto" runat="server" Text='<%# Eval("foto") %>' Visible="False"></asp:Label>
                                                <br />
