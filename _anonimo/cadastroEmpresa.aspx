...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="TituloBG" align="center">
        <tr>
            <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Cabec" runat="server" Text="Cadastre sua empresa" CssClass="TituloBGText"></asp:Label></td>
        </tr>
    </table>
    ...
    <cc1:DragPanelExtender ID="Panel1_DragPanelExtender" runat="server" 
        DragHandleID="Panel1" Enabled="False" TargetControlID="Panel1">
                ...
                <div style="text-align:left">
                    <asp:Label ID="LabelApresentaCadastroLabel" runat="server" 
                        Text="Para utilizar o sistema, a &lt;b&gt;#1#&lt;/b&gt;, aceita somente cadastro de Pessoa Jurídica.&lt;br&gt;&lt;br&gt;Pedimos o seu CNPJ pois é uma identificação importante que garante maior segurança no contato entre as empresas e os candidatos.&lt;br&gt;&lt;br&gt;Todas as informações enviadas no seu cadastro serão mantidas em sigilo e não serão repassadas a terceiros, conforme a nossa política de privacidade.&lt;br&gt;Para mais detalhes, você pode consultar nossos &lt;a href=&quot;/termosecondicoes.aspx&quot; title=&quot;Termos e Condições Gerais&quot;&gt;Termos e Condições Gerais&lt;/a&gt; ou entre em &lt;a title=&quot;Entre em contato&quot; href=&quot;/comercial/contato.aspx&quot;&gt;contato conosco&lt;/a&gt;. "></asp:Label>
                </div>
            </td>
        </tr>
     </table> 
                                                                ...
                                                                <tr>
                                                                    <td valign="top" align="left">
                                                                        <table cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:TextBox ID="cepTextBox" runat="server" CssClass="InputCad" Text='<%# Bind("cep") %>' Width="307px" ValidationGroup="CEP"></asp:TextBox>
                ...
                CssClass="InputCad" Width="327px"></asp:TextBox>
                    ...
                    Width="335px">
                                                                        ...
                                                                        Telefone para contato: [99] [99999-9999]<table cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:TextBox ID="ddd" runat="server" CssClass="InputCad" Width="50px" MaxLength="2"></asp:TextBox>
                                                                                    <asp:Image ID="Image15" runat="server" ImageUrl="~/images/5px.gif" />
                                                                                </td>
                                                                                <td>
                                                                                    <asp:TextBox ID="telefone" runat="server" CssClass="InputCad" Width="262px" MaxLength="10"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
        ...
        <tr>
            ...
            <td width="700">
                <asp:TextBox ID="TextBoxCondicoes" runat="server" CssClass="InputCad" 
                    Height="100px" TextMode="MultiLine" Width="687px"></asp:TextBox>
                </td>
        </tr>
    </table>
    <table class="TituloBG" align="center">
