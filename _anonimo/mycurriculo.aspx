                ...
                <table border="0" width="600" cellpadding="0" cellspacing="0">
                    <tr> 
                        <td width="465" valign="top">
                            ...
                            <asp:Label ID="idcurriculoLabel" runat="server" Visible="False"></asp:Label>
                                                            <asp:Label ID="idCurriculo_CRIPTOGRAFADOLabel" 
                    ...
                    runat="server" DataSourceID="SqlDADOSPESSOAIS" 
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="idcurriculoDBLabel" runat="server" 
                                                                    ...
                                                                    <asp:SqlDataSource ID="SqlDataSourceFORMACAO" runat="server" 
                                                                        ...
                                                                        <SelectParameters>
                                                                            <asp:ControlParameter ControlID="idcurriculoDBLabel" Name="idcurriculo" 
                                ...
                                <asp:SqlDataSource ID="SqlDADOSPESSOAIS" runat="server" 
                                    ...
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="idCurriculoLabel" Name="idCurriculo" 
                                            PropertyName="Text" Type="Int32" />
                                        <asp:ControlParameter ControlID="idCurriculo_CRIPTOGRAFADOLabel" 
                                            Name="idCurriculo_CRIPTOGRAFADO" PropertyName="Text" Type="String" />
