<%@ Page Language="VB" MasterPageFile="~/_anonimo/CurriculoPageWORD.master" AutoEventWireup="true" CodeFile="mycurriculoDOC.aspx.vb" Inherits="_candidato_mycurriculoDOC" title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
        <table width="626" cellpadding="0" cellspacing="0">
        <tr>
            <td width="26" style="height: 35px"><asp:Image ID="lateralInt" runat="server" ImageUrl="http://www.jobclick.com.br/images/h26.gif" /></td>
            <td width="600">
            
                <table border="0" width="600" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="bgimage" valign="top" width="135" height="131"><asp:Label ID="lblFoto" runat="server"></asp:Label>
                            <br />
                                                <asp:Image ID="ImageDef" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/deficienteT.gif" ImageAlign="Right" Visible="False" ToolTip="Pessoa com necessidades especiais." /></td>
                        <td width="465" valign="top"><asp:Image ID="Image1" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titdadospessoais.gif" /><br />
                            <table cellpadding="0" cellspacing="0" width="465">
                                <tr>
                                    <td width="26">
                                        <asp:Image ID="lateral" runat="server" ImageUrl="http://www.jobclick.com.br/images/h26.gif" /></td>
                                    <td width="439">
                                        <asp:DataList ID="DataList1" runat="server" DataKeyField="idCadastroUser" DataSourceID="SqlDataSource1" Width="420px">
                                            ...
                                            <ItemTemplate>
                                                <br />
                                                <br />
                                                <asp:Image ID="Image2" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titdeficiencia.gif" /><br />
                                            ...
                                            <ItemTemplate>
                                                <br />
                                                <br />
                                                <asp:Image ID="Image3" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titobjetivo.gif" /><br />
                                            ...
                                            <HeaderTemplate>
                                                <br />
                                                <asp:Image ID="Image5" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titformacao.gif" />
                                            </HeaderTemplate>
                                            <SeparatorTemplate>
                                                <asp:Image ID="Image4" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/separador.gif" />
                                            </SeparatorTemplate>
                                            ...
                                            <HeaderTemplate>
                                                <br />
                                                <br />
                                                <asp:Image ID="Image6" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titcursocomplementar.gif" />
                                            </HeaderTemplate>
                                            <SeparatorTemplate>
                                                <asp:Image ID="Image7" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/separador.gif" />
                                            </SeparatorTemplate>
                                            ...
                                            <HeaderTemplate>
                                                <br />
                                                <br />
                                                <asp:Image ID="Image8" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titconhecimentoinfo.gif" />
                                            </HeaderTemplate>
                                            <SeparatorTemplate>
                                                <asp:Image ID="Image9" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/separador.gif" />
                                            </SeparatorTemplate>
                                            ...
                                            <HeaderTemplate>
                                                <br />
                                                <br />
                                                <asp:Image ID="Image10" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titconhecimentoprof.gif" />
                                            </HeaderTemplate>
                                            <SeparatorTemplate>
                                                <asp:Image ID="Image9" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/separador.gif" />
                                            </SeparatorTemplate>
                                            ...
                                            <HeaderTemplate>
                                                <br />
                                                <br />
                                                <asp:Image ID="Image11" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titidioma.gif" />
                                            </HeaderTemplate>
                                            <SeparatorTemplate>
                                                <asp:Image ID="Image9" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/separador.gif" />
                                            </SeparatorTemplate>
                                            ...
                                            <HeaderTemplate>
                                                <br />
                                                <br />
                                                <asp:Image ID="Image12" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/titintercambio.gif" />
                                            </HeaderTemplate>
                                            <SeparatorTemplate>
                                                <asp:Image ID="Image9" runat="server" ImageUrl="http://www.jobclick.com.br/images/candidato/cv/separador.gif" />
                                            </SeparatorTemplate>
