<%@ Page Language="VB" MasterPageFile="~/_candidato/CandidatoPageJobClick.master" AutoEventWireup="true" CodeFile="mycurriculo.aspx.vb" Inherits="_candidato_mycurriculo" title="Jobclick" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="720px" cellpadding="0" cellspacing="0" align="center">
        <tr>
            <td width="30px" style="height: 35px"></td>
            <td width="690px" align="left"> 
                <center><asp:Label ID="LabelCurriculoAtivo" runat="server" Text="Curriculo Ativo:"></asp:Label></center>
                    ...
                    runat="server" DataSourceID="SqlDADOSPESSOAIS" 
                                                                ...
                                                                <ItemTemplate>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left" valign="top" width="600px">
                                                                                <table ID="CV" cellpadding="2" cellspacing="2" width="600px">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="right" valign="top" width="200px">
                                                                                            <asp:Label ID="Label37" runat="server" CssClass="textoGeral" 
                                                                                                Text="Curso extracurricular:"></asp:Label>
                                                                                        </td>
                                                                                        <td align="left" width="400">
                                                                                            <asp:DataList ID="DataListEXTRA" runat="server" DataKeyField="ID" 
                                                                                                DataSourceID="SqlCURSOEXTRACURRICULAR">
                                                                                                <ItemTemplate>
                                                                                                    <asp:Label ID="InstituicaoLabel" runat="server" CssClass="textDescritivo" 
                                                                                                        Font-Bold="True" Text='<%# Eval("Instituicao") %>' />
                                                                                                    <br />
                                                                                                    <asp:Label ID="dsCursoLabel" runat="server" CssClass="textDescritivo" 
                                                                                                        Text='<%# Eval("dsCurso") %>' />
                                                                                                    <br />
                                                                                                    <asp:Label ID="obsCursoLabel" runat="server" CssClass="textDescritivo" 
                                                                                                        Text='<%# Eval("obsCurso") %>' />
                                                                                                    <br />
                                                                                                    <asp:Label ID="data_iniLabel" runat="server" CssClass="textDescritivo" 
                                                                                                        Text='<%# Eval("data_ini") %>' />
                                                                                                    <br />
                                                                                                    <asp:Label ID="data_fimLabel" runat="server" CssClass="textDescritivo" 
                                                                                                        Text='<%# Eval("data_fim") %>' />
                                                                                                    <br />
                                                                                                    <asp:Label ID="concluido_textoLabel" runat="server" CssClass="textDescritivo" 
                                                                                                        Text='<%# Eval("concluido_texto") %>' />
                                                                                                    <br />
                                                                                                    <br />
                                                                                                </ItemTemplate>
                                                                                            </asp:DataList>
                                                                    ...
                                                                    <asp:SqlDataSource ID="SqlCURSOEXTRACURRICULAR" runat="server" 
                                                                        ConnectionString="<%$ ConnectionStrings:jobclickDB %>" 
                                                                        SelectCommand="_USP_CURRICULO_CURSO_EXTRACURRICULAR" 
                                                                        SelectCommandType="StoredProcedure">
                                                                        <SelectParameters>
                                                                            <asp:ControlParameter ControlID="idcurriculoLabel" Name="idcurriculo" 
                                                                                PropertyName="Text" Type="Int32" />
