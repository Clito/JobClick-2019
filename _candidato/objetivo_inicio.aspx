<%@ Page Language="VB" MasterPageFile="~/_candidato/CandidatoPageJobClick.master" AutoEventWireup="false" CodeFile="objetivo_inicio.aspx.vb" Inherits="_candidato_objetivo" title="Jobclick" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="720px" cellpadding="0" cellspacing="0" align="center">
        <tr>
            <td width="30px"><asp:Image ID="Image1" runat="server" ImageUrl="~/images/h26.gif" /></td>
            <td width="690px" align="left">
                <asp:Label ID="LabelMENSAGEM" runat="server" 
                    
                    Text="Parabéns! Você faz parte da família JobClick, agora você está em uma base de talentos central onde seus dados profissionais estarão disponíveis para todas as empresas que utilizam nosso sistema." 
                    CssClass="textSite"></asp:Label>
                <br />
                <br />
                <asp:Label ID="LabelATENCAO" runat="server" 
                    Text="&lt;b&gt;Atenção:&lt;/b&gt;&lt;br&gt;O seu Currículo Vitae &lt;b&gt;ainda não está totalmente pronto&lt;/b&gt; para ser apresentado aos Consultores/Analistas, existem informações importantes que devem ser informadas por você."></asp:Label>
                </td>
        </tr>
    </table> 
    <br /><br />
