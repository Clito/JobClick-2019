<%@ Page Title="" Language="VB" MaintainScrollPositionOnPostback="true" MasterPageFile="~/_comercial/ComercialMasterPage.master" AutoEventWireup="true" CodeFile="_cadastroLevantamento.aspx.vb" Inherits="_empresa_cadastroLevantamento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td width="26"></td>
                <td><asp:Label ID="LabelCabec" runat="server" CssClass="h1"></asp:Label></td>
            </tr>
        </table>
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td width="26"><asp:Image ID="Image1" runat="server" ImageUrl="~/images/h26.gif" /></td>
            <td><asp:Label ID="Label1" runat="server" CssClass="tituloEmp" Text="Levantamento do Perfil de Vaga"></asp:Label>
                ...
                <asp:GridView ID="GridViewListaPerfil" runat="server" AllowPaging="True" 
                    ...
                    DataSourceID="SqlListaPerfil0" PageSize="5" 
                    Width="100%">
                ...
                <table id="CadastraEmpresaTable" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><asp:Button ID="ButtonSelecionaEmpresa" runat="server" CssClass="button" 
    ...
    <br />
    <table runat="server" id="NavActions" visible="false" border="0" width="100%" 
            cellpadding="0" cellspacing="0">
        <tr>
            <td width="26"><asp:Image ID="Image2" runat="server" ImageUrl="~/images/h26.gif" /></td>
            <td><asp:Label ID="Label2" runat="server" CssClass="tituloEmp" 
                    Text="O que você deseja fazer?"></asp:Label>
                <asp:Label ID="NomeEmpresaLabel" runat="server" Visible="False"></asp:Label>
                <br />
                <br />
                <br />
                <asp:LinkButton ID="LinkButtonCadastroEdit" runat="server" 
                    CausesValidation="False" CssClass="button">Editar dados da empresa</asp:LinkButton>
                <asp:LinkButton ID="LinkButtonLevantamento" runat="server" 
                    CausesValidation="False" CssClass="button"> Emissão de Cobrança (Nota Fiscal)</asp:LinkButton>
                <asp:LinkButton ID="LinkButtonCancelar" runat="server" CausesValidation="False" 
                    CssClass="button" Visible="False">Cancelar</asp:LinkButton>
            </td>
        </tr>
    </table> 
<br />
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <br />
                                                    <asp:TextBox ID="TextBoxIE" runat="server" CssClass="InputCad" Width="327px"></asp:TextBox>
                                                </td>
                                                <td>
                                                    &nbsp;</td>
                                                <td>
        ...
        <tr>
            ...
            <td valign="top" width="650">
                    ...
                    <tr>
                        <td align="right" bgcolor="#F4FBFB" class="tableFormulario" width="35%">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator51" runat="server" 
                                ...
                                ErrorMessage="Informe qual Consultor receberá a atribuição" 
                        ...
                        <td bgcolor="#F4FBFB" class="tableFormulario" width="65%">
                            <asp:DropDownList ID="DropDownListConsultor" runat="server" CssClass="DropCad" 
                                DataSourceID="SqlConsultoresComercial" DataTextField="nome" DataValueField="idRH_Gestor" 
                ...
                <asp:Label ID="ConsultorCabecLabel0" runat="server" CssClass="titulo" 
                    Text="Responsável Comercial"></asp:Label>
                <br />
                ...
                <asp:Panel ID="PanelDadoDaEmpresa" runat="server" Width="100%">
                    ...
                    <asp:Label ID="LabelGeral1" runat="server" CssClass="titulo" 
                        ...
                        Text="Dados da Vaga" Visible="False"></asp:Label>
                            <br />
                            <asp:Label ID="LegendaLabel" runat="server" 
                        
                        Text="Legenda:&lt;br&gt;&lt;b&gt;PJ:&lt;/b&gt; Pessoa Jurídica | &lt;b&gt;CLT:&lt;/b&gt; Consolidação das Leis do Trabalho&lt;br&gt;&lt;b&gt;AQ:&lt;/b&gt; Aumento de Quadro | &lt;b&gt;S:&lt;/b&gt; Substituição " 
                        Visible="False"></asp:Label>
                    <table ID="RelVaga0" runat="server" cellpadding="0" cellspacing="0" class="tableFormulario" 
                        ...
                        <tr>
                            ...
                            <td class="tableFormulario" width="65%">
                                <asp:CheckBoxList ID="CheckBoxListBeneficio" OnSelectedIndexChanged="Check" 
                        ...
                        Text="Perfil do Candidato" Visible="False"></asp:Label>

                            <br />
                            <table ID="PerfilCandidato0" runat="server" cellpadding="0" cellspacing="0" width="100%" visible="False">
                                <tr>
                                    <td align="right" class="tableFormulario" width="35%">
                ...
                <table id="TAction" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="tableFormulario" width="35%">
                            &nbsp;</td>
                        <td class="tableFormulario" width="65%">
                                         <asp:LinkButton ID="LinkButtonAlterar" runat="server" 
                                            ValidationGroup="PerfilVagaForm" Visible="False" CssClass="button" 
                                             ToolTip="Enviar segunda via ao Financeiro">Reenviar ao Financeiro</asp:LinkButton>
                                         <asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" 
                                            CommandName="Insert" Text="Enviar ao Financeiro" 
                                ValidationGroup="PerfilVagaForm" CssClass="button" 
                                             ToolTip="Clique aqui para enviar ao Financeiro" />
...
<br />
    ...
    <asp:SqlDataSource ID="SqlListaPerfil0" runat="server" 
        ConnectionString="<%$ ConnectionStrings:jobclickDB %>" 
        SelectCommand="spPerfilVagaSelect_DataGrid" 
    ...
    <asp:SqlDataSource ID="SqlConsultoresTodos" runat="server" 
        ConnectionString="<%$ ConnectionStrings:jobclickDB %>" 
        SelectCommand="uspGestorSelectDropDownListComercial" 
            SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter Name="idCadastroEmpresa" SessionField="idCadastroEmpresa" 
                Type="Int32" />
        ...
        <asp:SqlDataSource ID="SqlConsultoresComercial" runat="server" 
            ConnectionString="<%$ ConnectionStrings:jobclickDB %>" 
            SelectCommand="uspGestorSelectDropDownListComercial" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
