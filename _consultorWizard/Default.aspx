<%@ Page Language="VB" MasterPageFile="~/_consultorWizard/ConsultorMasterPage.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="_empresa_Default" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="msg" runat="server"></asp:Label>
                <asp:Label ID="SetupLabel" runat="server"></asp:Label>
