<%@ Page Title="" Language="VB" MasterPageFile="~/_consultorWizard/ConsultorMasterPage.master" AutoEventWireup="false" CodeFile="_atualizacadastroCliente.aspx.vb" Inherits="_empresa_atualizacadastroCliente" %>
            ...
            <tr>
                ...
                <asp:Label ID="idUserEmpresaLabel" runat="server" Visible="False"></asp:Label>
                    ...
                    <asp:GridView ID="GridViewCliente" runat="server" AllowPaging="True" 
                        ...
                        DataSourceID="SqlEmpresa" Width="100%" PageSize="5">
                        <Columns>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" valign="bottom">
                                                    ...
                                                    <asp:ImageButton ID="ImageButtonCancelar" runat="server" 
                                                        ImageUrl="~/images/empresa/cancelar.png" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
