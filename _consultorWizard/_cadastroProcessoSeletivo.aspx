<%@ Page Title="" Language="VB" MasterPageFile="~/_consultorWizard/ConsultorMasterPage.master" AutoEventWireup="false" CodeFile="_cadastroProcessoSeletivo.aspx.vb" Inherits="_empresa_perfilVaga" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <table width="640" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <asp:GridView ID="GridViewListaProcessoSeletivo" runat="server" 
                    ...
                    <Columns>
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButtonSel" runat="server" 
                                    CommandName="Select" Text="Excluir Fase" 
                                    onclientclick="return confirm(&quot;Quer excluir esta fase?\nTem certeza que não existe registros nesta fase?&quot;)"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <br />
                <asp:Panel ID="PanelNavegador" runat="server" Visible="False">
    ...
    width="100%">
                ...
                <table cellpadding="2" cellspacing="0" ID="FormProcessoSeletivo" width="100%">
                    ...
                    <cc2:PieChart ID="PieChartPS" runat="server" BackColor="#E6F0F0" 
                        BackgroundGradientColors="" BackgroundTransparent="True" BalloonMaxWidth="200" 
                        BalloonTextFormatString="{title}: {value} dias ({percents}%)" BorderWidth="0px" 
                        CollectingDataMessageLeft="0px" CollectingDataMessageTop="" Colors="" 
                        DataLabelFormatString="{percents}%" DataLabelRadius="30px" 
                        DataSourceID="SqlPSVisaoGeralCHART" DataTitleField="dsFase" 
                        DataValueField="TotalDias" ErrorMessagesBackgroundGradientColors="" 
                        ErrorMessagesEnabled="False" ErrorMessagesLeft="" ErrorMessagesTop="" 
                        GroupColor="#FF3300" LegendAlign="Center" LegendBorderAlpha="0" 
                        LegendBorderColor="" LegendGradientColors="" LegendLeft="150px" 
                        LegendLeftMeasuredFromRight="True" LegendMargins="40" LegendSpacing="0" 
                        LegendTextSize="8pt" LegendTop="0px" LegendValueWidth="500" LegendWidth="500px" 
                        LoadingDataMessageText="Carregando" 
                        LoadingSettingsMessageText="Carregando Informações" 
                        NoDataErrorMessage="Não existem fases cadastradas" PieAngle="20" PieHeight="5" 
                        PieInnerRadius="0px" PieTop="10%" StartAnimationEffect="Regular" 
                ...
                <asp:SqlDataSource ID="SqlPSVisaoGeralCHART" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:jobclickDB %>" 
                    SelectCommand="_USP_PROCESSOSELETIVO_LISTA_CHART" 
                    SelectCommandType="StoredProcedure" 
                    DeleteCommand="_USP_PROCESSOSELETIVO_LISTA_EXCLUIR" 
                    DeleteCommandType="StoredProcedure">
                    <DeleteParameters>
