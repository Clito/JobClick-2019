...
Partial Class _empresa_runProcessoSeletivo
    ...
    Protected Sub ImageButtonImprimir_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonImprimir.Click
        Response.Redirect("/_anonimo/_mycurriculoDOC_Consultor.aspx?idCadastroUser=" & idCadastroEmpresaFilhaLabel.Text & "&idUser=" & idUserLabel.Text & "&id=" & idcurriculoLabel.Text & "&DocName=" & nomeCandidatoLabel.Text)
    End Sub
End Class
