<%@ Page Title="" Language="VB" MasterPageFile="~/_consultorWizard/ConsultorMasterPage.master" AutoEventWireup="false" CodeFile="agenda_schedule_Empresa.aspx.vb" Inherits="_empresa_agenda_schedule_Empresa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:Image ID="ImageCabec" runat="server" ImageUrl="~/images/empresa/titscheduleVagasEmpresas.gif" />
    <table id="agendaEmpresa" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td>
                <asp:LinkButton ID="LinkButtonVC" runat="server">Visualizar Calendário</asp:LinkButton>
                <br />
        ...
        <DayPilot:DayPilotScheduler ID="DayPilotSchedulerEmpresa" runat="server" 
            ...
            EventFontSize="10px" BorderStyle="Dotted" BorderWidth="1px" CellWidth="18" 
                ...
                <asp:Button ID="Button1" runat="server" CssClass="cur01st" Text="Selecionar" 
                            ...
                            <br />
                            <table id="FormTarefa" cellpadding="5" cellspacing="5" width="400px">
                                <tr>
                                    <td>
