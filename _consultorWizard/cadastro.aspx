<%@ Page Language="VB" MasterPageFile="~/_consultorWizard/ConsultorMasterPage.master" AutoEventWireup="false" CodeFile="cadastro.aspx.vb" Inherits="_empresa_cadastro" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/layout/e_cadastro.gif" /><br />
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="idCadastroEmpresa" DataSourceID="SqlDataSource5"
        ...
        <EditItemTemplate>
            Empresa: (Razão Social)<asp:TextBox ID="idUserTextBox" runat="server" Text='<%# Bind("idUser") %>' Visible="False" Width="8px"></asp:TextBox><asp:RequiredFieldValidator
