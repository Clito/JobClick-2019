<%@ Page Language="VB" MasterPageFile="~/_consultorWizard/ConsultorMasterPage.master" AutoEventWireup="false" CodeFile="main_processo.aspx.vb" Inherits="_empresa__processo_Default" title="Untitled Page" %>
            ...
            <td width="350">
                ...
                <asp:FormView ID="FormView1" runat="server" DataKeyNames="idProcessoSeletivo" 
                    ...
                    <InsertItemTemplate>
                        ...
                        Consultor:<br />
                        <asp:DropDownList ID="DDGestor" runat="server" CssClass="DropCadEmp" DataSourceID="SqlGestor"
                            DataTextField="nome" DataValueField="idRH_Gestor" AppendDataBoundItems="true" 
                            SelectedValue='<%# Bind("idRH_Gestor") %>' 
                            ondatabinding="DDGestor_DataBinding">
                            <asp:ListItem Text="" Value="" />
                        </asp:DropDownList><br />
                        Vaga:<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ControlToValidate="DDidvaga" ErrorMessage="A vaga é campo obrigatório.">*</asp:RequiredFieldValidator>
                        <br />
                        <asp:DropDownList ID="DDidvaga" runat="server" CssClass="DropCadEmp" DataSourceID="SqlVagaGestor"
                            DataTextField="codvaga" DataValueField="idVaga" AppendDataBoundItems="true" OnDataBinding="DDidvaga_DataBinding"
                            SelectedValue='<%# Bind("idVaga") %>'>
                            <asp:ListItem Text="" Value="" />
                        </asp:DropDownList><br />
                        Processo Seletivo (Descrição) Ex.: [PS Vaga Técnico]
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="dsProcessoTextBox"
                            Display="Dynamic" ErrorMessage="O nome do Processo é obrigatório." 
                            SetFocusOnError="True">*</asp:RequiredFieldValidator><br />
                        <asp:TextBox ID="dsProcessoTextBox" runat="server" CssClass="InputCadEmp" Text='<%# Bind("dsProcesso") %>'></asp:TextBox><br />
                        <asp:ValidationSummary ID="ValidationSummaryPS" runat="server" 
