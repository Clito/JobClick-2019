<%@ Page Title="" Language="VB" MasterPageFile="~/_consultorWizard/ConsultorMasterPage.master" AutoEventWireup="false" CodeFile="pesquisaCVbase.aspx.vb" Inherits="_consultorWizard_pesquisaCVbase" %>
                        ...
                        <tr>
                            <td width="100%">
                                ...
                                <asp:FormView ID="FormViewFiltro" runat="server" 
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:ImageButton ID="ImageButton4" runat="server" CommandName="Update" 
                                            ImageUrl="~/images/empresa/salvar.png" />
                                        <asp:ImageButton ID="ImageButton5" runat="server" CausesValidation="False" 
                                            CommandName="Cancel" ImageUrl="~/images/empresa/cancelar.png" />
                                    </EditItemTemplate>
                                    <EmptyDataTemplate>
                                        <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" 
                                            CommandName="New" ImageUrl="~/images/empresa/btFiltroPesquisa.png" />
                                    </EmptyDataTemplate>
                                    <InsertItemTemplate>
                                        <br />
                                        <asp:Label ID="Label2" runat="server" Text="Escola um dos filtro dinâmico:"></asp:Label>
                                        ...
                                        <br />
                                        <asp:ImageButton ID="ImageButton3" runat="server" CommandName="Insert" 
                                            ImageUrl="~/images/empresa/salvar.png" />
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton ID="ImageButton8" runat="server" CausesValidation="False" 
                                            CommandName="Edit" ImageUrl="~/images/empresa/btAlterar.png" />
                                        &nbsp;<asp:ImageButton ID="ImageButton6" runat="server" CausesValidation="False" 
                                            CommandName="Delete" ImageUrl="~/images/empresa/btExcluir.png" />
                                ...
                                <asp:ImageButton ID="ImageButtonPSQ" runat="server" 
                                    ImageUrl="~/images/empresa/pesquisa.png" />
                                <br />
                                <br />
