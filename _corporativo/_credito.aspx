<%@ Page Title="" Language="VB" MasterPageFile="~/_corporativo/corporativoPage.master" AutoEventWireup="false" CodeFile="_credito.aspx.vb" Inherits="_empresaJC_credito" %>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Label ID="precoLabel" runat="server" CssClass="textBold" Text='<%# Eval("preco", "{0:C}") %>' />
                                        <asp:Label ID="Labeldt" runat="server" CssClass="textoGeral" Text='<%# Eval("byMes") %>'></asp:Label>
                                        <br />
                                        <br />
