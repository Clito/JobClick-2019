<%@ Page Title="" Language="VB" MaintainScrollPositionOnPostback="false" MasterPageFile="~/_corporativo/corporativoPage.master" AutoEventWireup="true" CodeFile="cadastroVaga.aspx.vb" Inherits="_empresa_cadastroLevantamento" %> 
    ...
    <table id="BodyInterno" runat="server" border="0" cellpadding="0" cellspacing="0" visible="true" align="center" width="930px">
        <tr>
            ...
            <td valign="top" width="900" align="left">
                            <asp:Label ID="msn" runat="server" CssClass="textoProcessoSeletivoFECHADO"></asp:Label>
                            <br />
                                    <asp:Label ID="LabelPesquisadosProcessosSeletivos" runat="server" CssClass="h1" 
                                    Text="Abertura de novas vagas"></asp:Label>
                                    <br />
                                            ...
                                            <table ID="OutLookPerfil" runat="server" visible="true" cellpadding="5" 
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br />
                                                        <br />
                                                        <asp:Label ID="mensagemLabel" runat="server" Text="Mensagem: (Gestor/Departamento):" 
                                                            CssClass="textoProcessoSeletivo"></asp:Label>
