<%@ Page Title="" Language="VB" MasterPageFile="~/_corporativo/corporativoPage.master" AutoEventWireup="false" CodeFile="quiz.aspx.vb" Inherits="_corporativo_quiz" %>
                ...
                <table cellpadding="0" cellspacing="0" align="center" width="100%">
                    <tr>
                        <td>
                            ...
                            <br />
                            <br />
                                <table cellpadding="0" cellspacing="0" id="BodyInterno" width="850px" align="center">
                                    <tr>
                                        <td align="left">
                                            ...
                                            <asp:FormView ID="FormViewQUIZ" runat="server" DataKeyNames="idQuiz" 
                                                ...
                                                <ItemTemplate>
                                                    <table ID="Quiz" cellpadding="2" cellspacing="0" width="850px">
                                                        <tr>
                                                            <td align="right" valign="top" width="250px">
                                                                <asp:Label ID="Label2" runat="server" Text="Nota de corte:"></asp:Label>
                                                            </td>
                                                    ...
                                                    <asp:FormView ID="FormViewPerguntaResposta" runat="server" DataKeyNames="ID" 
                                                        ...
                                                        <ItemTemplate>
                                                            <table bgcolor="#FFFFEA" cellpadding="2" cellspacing="0" width="850px">
                                                                <tr>
