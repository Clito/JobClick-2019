<%@ Page Title="" Language="VB" MasterPageFile="~/_corporativo_departamento/corporativoPage.master" MaintainScrollPositionOnPostback="false" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="_corporativo_Default" %>
                    ...
                    <table id="CONSULTOR" runat="server" border="0" cellpadding="0" cellspacing="0" visible="true" align="left" width="900px">
                        <tr>
                            ...
                            <div id="MENUPRINCIPAL">
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:Label ID="LabelREPLICAR" runat="server" CssClass="tituloProcessoSeletivo" Text='<%# Eval("replicarTEXTO") %>'></asp:Label>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <asp:HyperLink ID="HyperLinkSMS" runat="server" CssClass="button" 
                                                        NavigateUrl="~/_corporativo_departamento/_credito.aspx" 
                                                    ...
                                                    <asp:LinkButton ID="LinkButtonEXTRATO" runat="server" CssClass="button" 
                                                        PostBackUrl="~/_corporativo_departamento/_extrato.aspx" 
                                ...
                                <div><table id="FORMACESSO" cellpadding="2" cellspacing="2" width="800">
                                    <tr>
                                        ...
                                        <td width="500">
                                            ...
                                            <asp:TextBox ID="passwordTextBox" runat="server" CssClass="InputCadFormCandidatoCV" 
                                                ValidationGroup="ATIVA" Width="290px" TextMode="Password"></asp:TextBox>
                                                    ...
                                                    <td>
&nbsp;<asp:LinkButton ID="LinkButtonATIVA" runat="server" CssClass="button" ValidationGroup="ATIVA">Ativar alteração da conta</asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <div>&nbsp;<br />
                                    ...
                                    <br />
                                    <asp:FormView ID="FormViewAREA" runat="server" AllowPaging="True" BackColor="#FFFFE8" DataKeyNames="idRH" DataSourceID="SqlDataSourcetbuserTypeFORM" Width="100%" Visible="False">
                                        <EditItemTemplate>
...
&nbsp;<asp:LinkButton ID="InsertCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" CssClass="button" Text="Cancelar" />
                                    ...
                                    <br />
                                    <table id="FORM" runat="server" visible="false" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td>
    ...
    <asp:SqlDataSource ID="SqlDataSourcetbuserTypeFORM" runat="server" 
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <br />
                                                <table id="COMUNICADOR" cellpadding="2" cellspacing="2" width="800">
                                                    ...
                                                    <tr>
                                                        <td align="right" valign="top" width="300">
                                                            <asp:Label ID="Label8" runat="server" Text="Observações:" Visible="False"></asp:Label>
                                                        </td>
                                                        <td width="500">
                                                            <asp:Label ID="parecerAnalista_ConsultorLabel" runat="server" 
                                                                Text='<%# Bind("parecerAnalista_Consultor") %>' Visible="False" />
        ...
        <br />
                                ...
                                <asp:SqlDataSource ID="SqlVAGASALVA" runat="server" 
                                    ConnectionString="<%$ ConnectionStrings:jobclickDB %>" 
                                    SelectCommand="_USP_VAGA_SALVA_REQUISITANTE" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="idCadastroEmpresa" SessionField="idCadastroEmpresa" 
                                            Type="Int32" />
