...
Partial Class _empresa_atualizaVaga
    ...
    Protected Sub FormViewVaga_DataBound(sender As Object, e As System.EventArgs) Handles FormViewVaga.DataBound
        Try
            CType(FormViewVaga.FindControl("HyperLinkPreView"), HyperLink).NavigateUrl = "/_empresa/previewVaga.aspx?autoTit=" & Request.QueryString("autoTit") & "&Protocolo=" & ProtocoloLabel.Text
        Catch ex As Exception
