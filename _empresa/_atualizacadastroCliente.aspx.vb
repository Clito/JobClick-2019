...
Partial Class _empresa_atualizacadastroCliente
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            REM ** ********************************************************************************************************
            REM ** REQUISIÇÃO DE OUTRA PÁGINA (/_empresa/_infoCliente.aspx?autoTit=Informações%20sobre%20as%20empresas%20cadastradas)
            REM ** ********************************************************************************************************
            If Request.QueryString("idCadastroEmpresa") <> "" Then
                idCadastroEmpresaLabel.Text = Request.QueryString("idCadastroEmpresa_Pai")
