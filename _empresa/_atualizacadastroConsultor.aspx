<%@ Page Title="" Language="VB" MasterPageFile="~/_empresa/EmpresaPage.master" AutoEventWireup="false" CodeFile="_atualizacadastroConsultor.aspx.vb" Inherits="_empresa_atualizacadastroConsultor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <tr>
            ...
            <td width="350">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                    DataKeyNames="idRH" DataSourceID="SqlDataSource5" GridLines="None" 
                    Width="614px" Visible="False">
                    <Columns>
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="idRH" 
                    DataSourceID="SqlDataSource6" Visible="False">
        <EditItemTemplate>
        ...
        <InsertItemTemplate>
            <asp:Label ID="Label10" runat="server" Font-Bold="True" 
                Text="Nome da equipe (Grupo): "></asp:Label>
            <asp:TextBox ID="idCadastroEmpresaTextBox0" runat="server" Text='<%# Bind("idCadastroEmpresa") %>'
                Visible="False" Width="8px"></asp:TextBox>
            <asp:DropDownList ID="DropDownList4" runat="server"
                    DataSourceID="SqlDataSource4" DataTextField="idCadastroEmpresa" DataValueField="idCadastroEmpresa"
                    SelectedValue='<%# Bind("idCadastroEmpresa") %>' Visible="False">
                </asp:DropDownList>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="RH_vinculoTextBox"
                Display="Dynamic" ErrorMessage="*"></asp:RequiredFieldValidator><br />
            Obs.: Crie várias equipes de consultores.<br />
            <asp:TextBox ID="RH_vinculoTextBox0" runat="server" CssClass="InputCadEmp" 
                Text='<%# Bind("dsRH_vinculo") %>'></asp:TextBox><br />
            <asp:Label ID="Label11" runat="server" Font-Bold="True" Text="Observações:"></asp:Label>&nbsp;<asp:RequiredFieldValidator 
                ID="RequiredFieldValidator5" runat="server" 
                ControlToValidate="dsvinculoTextBox" Display="Dynamic" ErrorMessage="*" 
                SetFocusOnError="True"></asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Label12" runat="server" Text="Descreva qual é a especialidade da equipe ou do grupo.<br>Se for a contratação de um especialista descreva as <br>características da contatação e/ou sua finalidade."
                Width="350px"></asp:Label><br />
            <asp:TextBox ID="dsvinculoTextBox0" runat="server" CssClass="InputCadEmp" Height="100px"
                Text='<%# Bind("dsvinculo") %>' TextMode="MultiLine"></asp:TextBox><br />
            <br />
        ...
        <EmptyDataTemplate>
            ...
            <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="New"
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                    ...
                    <EmptyDataTemplate>
                        <br />
                        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/layout/antencao.gif" />
                        <asp:Label ID="info0" runat="server" Text="Não há consultores cadastrados. "></asp:Label>
                        <br />
                        <br />
                        &nbsp;&nbsp;
                        <asp:HyperLink ID="HyperLink1" runat="server" 
                            NavigateUrl="_cadastroConsultor.aspx?autoTit=Cadastro%20de%20novos%20Consultores">Para cadastrar um Consultor clique aqui!</asp:HyperLink>
                    </EmptyDataTemplate>
                    <AlternatingRowStyle BackColor="Azure" />
                </asp:GridView>
                <br />
                <asp:FormView ID="FormView2" runat="server" DataKeyNames="idUser" 
                    ...
                    <EditItemTemplate>
                        ...
                        <br />
                        <asp:DropDownList ID="DropDownList2" runat="server" CssClass="DropCad" DataSourceID="SqlDataSource2"
                            DataTextField="dsRH_vinculo" DataValueField="idRH" 
                            SelectedValue='<%# Bind("idRH") %>'>
                        </asp:DropDownList><br />
                        ...
                        <asp:TextBox ID="passwordTextBox" runat="server" CssClass="InputCad" MaxLength="16"
                    ...
                    <InsertItemTemplate>
                        <asp:TextBox ID="idCadastroEmpresaTextBox2" runat="server" Text='<%# Bind("idCadastroEmpresa") %>'
                            Visible="False" Width="5px"></asp:TextBox>
                        <asp:DropDownList ID="DropDownList5" runat="server"
                                DataSourceID="SqlDataSource4" DataTextField="idCadastroEmpresa" DataValueField="idCadastroEmpresa"
                                SelectedValue='<%# Bind("idCadastroEmpresa") %>' Visible="False">
                            </asp:DropDownList>
                        <asp:TextBox ID="idRH_vinculoTextBox0" runat="server" Text='<%# Bind("idRH") %>'
                                Visible="False" Width="5px"></asp:TextBox>
                        <asp:TextBox ID="idUserTextBox0" runat="server" Text='<%# Bind("idUser") %>' 
                            Visible="False" Width="5px"></asp:TextBox>
                        <br />
                        <asp:DropDownList ID="DropDownList6" runat="server" CssClass="DropCadEmp" 
                        ...
                        <br />
                        <asp:DropDownList ID="DropDownListAcesso0" runat="server" CssClass="DropCadEmp" 
                            DataSourceID="SqlDataSourcetbuserType" DataTextField="idTypeUser" 
                            DataValueField="idTypeUser" SelectedValue='<%# Bind("idTypeUser") %>'>
                        </asp:DropDownList>
                        <br />
                        ...
                        <br />
                        <asp:TextBox ID="nomeTextBox0" runat="server" CssClass="InputCadEmp" 
                            Text='<%# Bind("nome") %>'></asp:TextBox>
                        <br />
                        <asp:Label ID="Label14" runat="server" Text="User Name (Utilizado no Login)"></asp:Label>
                        <br />
                        <asp:TextBox ID="usernameTextBox0" runat="server" CssClass="InputCadEmp" 
                            Text='<%# Bind("userName") %>'></asp:TextBox>
                        <br />
                        Senha de acesso (Password):<asp:RequiredFieldValidator 
                            ...
                            SetFocusOnError="True"></asp:RequiredFieldValidator>
                        <br />
                        <asp:TextBox ID="passwordTextBox0" runat="server" CssClass="InputCadEmp" 
                        ...
                        <br />
                        <asp:TextBox ID="emailTextBox0" runat="server" CssClass="InputCadEmp" 
                            Text='<%# Bind("email") %>'></asp:TextBox>
                        <br />
                        <asp:Label ID="Label15" runat="server" Text="Frase para recuperar senha:"></asp:Label>
                        <br />
                        <asp:TextBox ID="FraseTextBox0" runat="server" CssClass="InputCadEmp" 
                            Text='<%# Bind("frase") %>'></asp:TextBox>
                        <br />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" 
                            ControlToValidate="dddTextBox" ErrorMessage="DDD é obrigatório!"></asp:RequiredFieldValidator>
                        <br />
                        <asp:TextBox ID="dddTextBox0" runat="server" CssClass="InputCadEmp" 
                            Text='<%# Bind("ddd") %>' Width="80px"></asp:TextBox>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
                            ControlToValidate="telefoneTextBox" ErrorMessage="Telefone é Obrigatório!"></asp:RequiredFieldValidator>
                        <br />
                        <asp:TextBox ID="telefoneTextBox0" runat="server" CssClass="DropCadEmp" 
                            Text='<%# Bind("telefone") %>'></asp:TextBox>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                            ControlToValidate="CPFTextBox" ErrorMessage="CPF é Obrigatório!"></asp:RequiredFieldValidator>
                        <br />
                        <asp:TextBox ID="CPFTextBox0" runat="server" CssClass="InputCadEmp" 
                            Text='<%# Bind("cpf") %>'></asp:TextBox>
...
&nbsp;<asp:Label ID="telefoneLabel" runat="server" Font-Bold="True" Text='<%# Eval("telefone") %>'></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:jobclickDB %>"
        SelectCommand="_USP_LISTA_CONSULTOR_CREDITO" 
