<%@ Page Title="" Language="VB" MasterPageFile="~/_empresa/EmpresaPage.master" AutoEventWireup="false" CodeFile="_cadastroConsultor.aspx.vb" Inherits="_empresa_cadastroConsultor" %>
        ...
        <table width="640" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <asp:FormView ID="FormView2" runat="server" DataKeyNames="idUser" 
                    DataSourceID="SqlDataSource3" Width="100%" DefaultMode="Insert">
                    <EditItemTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
                            ControlToValidate="DropDownListAcesso" 
                            ErrorMessage="• Nível de acesso é obrigatório!"></asp:RequiredFieldValidator>
                        <br />
