...
Partial Class _empresa_cadastroConsultor
    ...
    Protected Sub SqlDataSource3_Inserted(sender As Object, e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs) Handles SqlDataSource3.Inserted
        Response.Redirect("_atualizacadastroConsultor.aspx?autoTit=Atualiza%20informa%C3%A7%C3%B5es%20sobre%20o%20Consultor")
    End Sub

    Protected Sub FormView2_DataBound(sender As Object, e As System.EventArgs) Handles FormView2.DataBound

        Try
            Dim myDropDownListidCadEmpresa As DropDownList = CType(FormView2.FindControl("DropDownListAcesso"), DropDownList)
