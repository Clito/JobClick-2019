...
Partial Class _empresa_cadastroLevantamento
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            REM ** ***************************************************************************************************
            REM ** VEM DE UM REDIRECIONAMENTO
            REM ** ***************************************************************************************************
            If Request.QueryString("idPerfilVaga") <> "" Then

                Dim idPerfilVagaRQ As Int32 = 0
                ...
                idPerfilVagaRQ = Request.QueryString("idPerfilVaga")
                ProtocoloLabel.Text = Request.QueryString("Protocolo")
                idPerfilVagaLabel.Text = idPerfilVagaRQ
                idRH_GestorLabel.Text = Request.QueryString("idRH_Gestor")

                idCadastroEmpresaLabel.Text = Request.QueryString("idCadastroEmpresaFilha")
                idCadastroEmpresaFilhaLabel.Text = Request.QueryString("idCadastroEmpresaFilha")
                Session("idCadastroEmpresaFilha") = idCadastroEmpresaFilhaLabel.Text

                NomeEmpresaLabel.Text = "<b>Empresa selecionada " & Request.QueryString("nmempresa") & "</b>"
                ...
                idRH_GestorLabel.Text = Request.QueryString("idRH_Gestor")
                dataLevantamentoLabel.Text = Request.QueryString("data_criacao")

                GetPerfilVaga(idPerfilVagaRQ)
                GetDadosConsultor(idRH_GestorLabel.Text)
                AtualizaEmpresa()
    ...
    Protected Sub DropDownListConsultor_DataBound(sender As Object, e As System.EventArgs) Handles DropDownListConsultor.DataBound
        If IsPostBack Then
            Try
                ...
                myDropDownListConsultor.SelectedValue = idRH_GestorLabel.Text
            Catch ex As Exception
                Dim myDropDownListConsultor As DropDownList = DropDownListConsultor
                'myDropDownListConsultor.Items.Insert(0, New ListItem(Session("nome"), "0"))
            End Try
    ...
    Sub Check(sender As Object, e As EventArgs) Handles CheckBoxListBeneficio.SelectedIndexChanged
        BeneficiosTextBox.Text = ""
        Dim i As Int32
