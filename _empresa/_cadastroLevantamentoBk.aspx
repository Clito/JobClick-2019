<%@ Page Title="" Language="VB" MaintainScrollPositionOnPostback="true" MasterPageFile="~/_empresa/EmpresaPage.master" AutoEventWireup="true" CodeFile="_cadastroLevantamento.aspx.vb" Inherits="_empresa_cadastroLevantamento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <tr>
            ...
            <td width="614"><asp:Label ID="Label1" runat="server" CssClass="tituloEmp" Text="Levantamento do Perfil de Vaga"></asp:Label>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlConsultor" runat="server" 
        ...
        <SelectParameters>
            <asp:SessionParameter Name="idCadastroEmpresa" SessionField="idCadastroEmpresa" 
                Type="Int32" />
            <asp:Parameter DefaultValue="Consultor" Name="idTypeUser" />
            <asp:Parameter DefaultValue="Consultor Wizard" Name="idTypeUser1" />
        </SelectParameters>
    </asp:SqlDataSource>
