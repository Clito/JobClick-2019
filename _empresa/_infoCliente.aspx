<%@ Page Title="" Language="VB" MasterPageFile="~/_empresa/EmpresaPage.master" AutoEventWireup="false" CodeFile="_infoCliente.aspx.vb" Inherits="_empresa_infoCliente" %>
            ...
            <tr>
                ...
                <td width="614">
                    ...
                    <asp:GridView ID="GridViewCliente" runat="server" AutoGenerateColumns="False" 
                        ...
                        DataKeyNames="idCadastroEmpresa,idCadastroEmpresa_Pai" DataSourceID="SqlDataCliente" 
