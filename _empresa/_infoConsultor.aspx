<%@ Page Title="" Language="VB" MasterPageFile="~/_empresa/EmpresaPage.master" AutoEventWireup="false" CodeFile="_infoConsultor.aspx.vb" Inherits="_empresa_infoConsultor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <td width="350">
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                    ...
                    <Columns>
                        ...
                        <asp:CommandField SelectText="Selecionar Grupo" ShowSelectButton="True">
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="idRH" 
        ...
        <InsertItemTemplate>
            ...
            <asp:TextBox ID="RH_vinculoTextBox" runat="server" CssClass="InputCadEmp" 
        ...
        <ItemTemplate>
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Edit" 
                ImageUrl="~/images/layoutNew/btEditaGrupoAcesso.png" 
                ToolTip="Clique aqui para abrir o formulário de edição do grupo selecionado acima." />
            <asp:ImageButton ID="ImageButtonNew" runat="server" CommandName="New" 
                ImageUrl="~/images/layoutNew/btCriaNovoGrupoAcesso.png" 
                ToolTip="Clique aqui para criar um novo grupo de acesso." />
        </ItemTemplate>
        <EmptyDataTemplate>
            <asp:ImageButton ID="ImageButtonNew" runat="server" CommandName="New" 
                ImageUrl="~/images/layoutNew/btCriaNovoGrupoAcesso.png" />
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                    DataKeyNames="idUser" DataSourceID="SqlDataSource1" GridLines="None" 
                    Width="614px" Visible="False">
                    <Columns>
                        <asp:BoundField DataField="idUser" HeaderText="idUser" SortExpression="idUser" Visible="False" />
                        <asp:BoundField DataField="idCadastroEmpresa" HeaderText="idCadastroEmpresa" SortExpression="idCadastroEmpresa"
                            Visible="False" />
                        <asp:ButtonField CommandName="Select" DataTextField="nome" HeaderText="Nome:" 
                            Text="Button" />
                ...
                <asp:FormView ID="FormView2" runat="server" DataKeyNames="idUser" 
                    DataSourceID="SqlDataSource3" Width="100%" Visible="False">
                    <EditItemTemplate>
                    ...
                    <InsertItemTemplate>
                        ...
                        <br />
                        <asp:DropDownList ID="DropDownListAcesso0" runat="server" CssClass="DropCad" 
                            DataSourceID="SqlDataSourcetbuserType" DataTextField="idTypeUser" 
                            DataValueField="idTypeUser" SelectedValue='<%# Bind("idTypeUser") %>'>
                        </asp:DropDownList>
                        <br />
                        ...
                        <br />
                        <asp:TextBox ID="nomeTextBox0" runat="server" CssClass="InputCad" 
                            Text='<%# Bind("nome") %>'></asp:TextBox>
                        <br />
                        <asp:Label ID="Label14" runat="server" Text="User Name (Utilizado no Login)"></asp:Label>
                        <br />
                        <asp:TextBox ID="usernameTextBox0" runat="server" CssClass="InputCad" 
                            Text='<%# Bind("userName") %>'></asp:TextBox>
                        <br />
                        Senha de acesso (Password):<asp:RequiredFieldValidator 
                            ...
                            SetFocusOnError="True"></asp:RequiredFieldValidator>
                        <br />
                        <asp:TextBox ID="passwordTextBox0" runat="server" CssClass="InputCad" 
                        ...
                        <br />
                        <asp:TextBox ID="FraseTextBox0" runat="server" CssClass="InputCad" 
                            Text='<%# Bind("frase") %>'></asp:TextBox>
                        <br />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" 
                            ControlToValidate="dddTextBox" ErrorMessage="DDD é obrigatório!"></asp:RequiredFieldValidator>
                        <br />
                        <asp:TextBox ID="dddTextBox0" runat="server" CssClass="InputCad" 
                            Text='<%# Bind("ddd") %>' Width="80px"></asp:TextBox>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
                            ControlToValidate="telefoneTextBox" ErrorMessage="Telefone é Obrigatório!"></asp:RequiredFieldValidator>
                        <br />
                        <asp:TextBox ID="telefoneTextBox0" runat="server" CssClass="InputCad" 
                            Text='<%# Bind("telefone") %>'></asp:TextBox>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                            ControlToValidate="CPFTextBox" ErrorMessage="CPF é Obrigatório!"></asp:RequiredFieldValidator>
                        <br />
                        <asp:TextBox ID="CPFTextBox0" runat="server" CssClass="InputCad" 
                            Text='<%# Bind("cpf") %>'></asp:TextBox>
