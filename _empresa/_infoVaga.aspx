<%@ Page Title="" Language="VB" MasterPageFile="~/_empresa/EmpresaPage.master" AutoEventWireup="false" CodeFile="_infoVaga.aspx.vb" Inherits="_empresa_infoVaga" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="LabelAviso" runat="server" 
                                            Text="Não existe(m) anúncio(s) para ser(em) publicado(s).&lt;br&gt;Crie um novo Levantamento de Perfil da Vaga, após aprovado ele fará parte desta lista."></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </EmptyDataTemplate>
