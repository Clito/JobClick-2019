<%@ Page Title="" Language="VB" MasterPageFile="~/_empresa/EmpresaPage.master" AutoEventWireup="false" CodeFile="previewVaga.aspx.vb" Inherits="_empresa_previewVaga" %>
                        ...
                        <asp:DetailsView ID="DetailsViewVaga" runat="server" AllowPaging="True" 
                            ...
                            <Fields>
                                <asp:CommandField CancelText="Cancelar" DeleteText="Excluir" 
                                    EditText="Editar Anúncio" ShowEditButton="True" />
                                ...
                                <asp:TemplateField HeaderText="PerfilGestor" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox41" runat="server" CssClass="InputCad" Text='<%# Bind("PerfilGestor") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Conhecimento" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox45" runat="server" CssClass="InputCad" Text='<%# Bind("Conhecimento") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="AspectoCritico" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox53" runat="server" CssClass="InputCad" Text='<%# Bind("AspectoCritico") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:CommandField ShowEditButton="True" CancelText="Cancelar" 
                                    DeleteText="Excluir" EditText="Editar Anúncio" />
                            </Fields>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:HyperLink ID="HyperLinkVoltar" runat="server" 
                                        NavigateUrl="~/_empresa/vaga.aspx">Voltar</asp:HyperLink>
                                    <br />
                                    <br />
                                </td>
                            </tr>
