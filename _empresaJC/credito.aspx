<%@ Page Title="" Language="VB" MasterPageFile="~/_empresaJC/EmpresaPage.master" AutoEventWireup="false" CodeFile="credito.aspx.vb" Inherits="_empresaJC_credito" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="LabeldsCredito" runat="server" 
                                    Text="Apresentamos para você um novo modelo de utilização do sistema JOBCLICK, trata-se da &quot;VAGA PATROCINADA&quot;, com ele você poderá comprar &quot;créditos&quot; para serem utilizados na gestão completa de sua vaga, neste modelo você paga o que usa, gerando economia para sua empresa!"></asp:Label>
                                <br />
