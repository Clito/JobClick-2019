...
Partial Class _empresaJC_credito
    ...
    Protected Sub ImageButtonCredito350_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonCredito350.Click, ImageButtonCred5.Click
        ...
        'VendaPagSeguroCredito.UrlPagSeguro = "http://localhost:9090/security/webpagamentos/webpagto.aspx"
        VendaPagSeguroCredito.UrlPagSeguro = "https://pagseguro.uol.com.br/checkout/checkout.jhtml" ' //pagseguro.uol.com.br/pagseguro-ws/checkout/NPI.jhtml
