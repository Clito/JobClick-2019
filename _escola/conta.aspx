<%@ Page Language="VB" MasterPageFile="~/_escola/escola.master" AutoEventWireup="false" CodeFile="conta.aspx.vb" Inherits="_empresa_conta" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Image ID="Image1" runat="server" 
        ImageUrl="~/images/titcontadeacessoEscola.gif" /><br />
