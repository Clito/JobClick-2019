<%@ Page Title="" Language="VB" MaintainScrollPositionOnPostback="true" MasterPageFile="corporativoPage.master" AutoEventWireup="false" CodeFile="_indica.aspx.vb" Inherits="_gestor_indica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
        ...
        <table cellpadding="0" cellspacing="0" ID="Table1" width="750" align="center">
            <tr>
                <td><asp:Label ID="LabelCabec" runat="server" CssClass="tituloEmpresa"></asp:Label>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="LabelCabec0" runat="server" CssClass="tituloEmpresa">Indicações enviadas:</asp:Label>
                                                <br />
                                <asp:GridView ID="GridViewIndicado" runat="server" AutoGenerateColumns="False" BorderStyle="None" 
                                    DataKeyNames="idCVIndicado" DataSourceID="SqlListaIndicado" Width="100%" GridLines="None">
                                ...
                                <asp:GridView ID="GridViewPSQProf" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Candidato localizado" ShowHeader="False">
                                            ...
                                            <HeaderTemplate>
                                                <asp:Label ID="Label1" runat="server" Font-Bold="True" 
                                                    Text="Candidato localizado:"></asp:Label>
                                            </HeaderTemplate>
                                            <ItemStyle BackColor="#D2E8D6" />
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="cpf" HeaderText="cpf" SortExpression="cpf" 
                                            Visible="False" />
                                        <asp:BoundField DataField="nome" HeaderText="Candidato" SortExpression="nome" 
                                        ...
                                        <asp:BoundField DataField="email" HeaderText="E-mail" SortExpression="email" />
                                                ...
                                                <br />
                                                <asp:Label ID="LabelCabec2" runat="server" CssClass="titulo">Informe para qual vaga deseja indicar o profissional:</asp:Label>
                                                <br />
                                                <asp:GridView ID="GridViewVAGA" runat="server" AllowPaging="True" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="idVaga" HeaderText="idVaga" SortExpression="idVaga" 
                                                            Visible="False" />
                                                        <asp:BoundField DataField="dsCargo" HeaderText="Cargo (CBO)" 
                                                            SortExpression="dsCargo">
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                    <EmptyDataTemplate>
                                                        <asp:Label ID="Label4" runat="server" Text="Não há vagas publicadas."></asp:Label>
                                                    </EmptyDataTemplate>
                                                </asp:GridView>
                                <asp:Panel ID="PanelFormularioIndica" runat="server">
                                    <asp:Label ID="LabelCabec1" runat="server" CssClass="titulo">Formulário de indicações:</asp:Label>
                                    <br />
                                    <asp:Label ID="msn" runat="server" CssClass="msnOK"></asp:Label>
                                    <asp:Label ID="msnEmailCandidato" runat="server"></asp:Label>
                                    <br />
                                    <table cellpadding="0" cellspacing="0" ID="FormularioIndicador" width="700" 
                                        align="center">
                                        <tr>
                                            <td>
                                                <asp:Label ID="LabelCmp0" runat="server" 
                                                    Text="CPF do candidato (Para ver se tem cadastro):"></asp:Label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="emailTextBox" runat="server" CssClass="InputCad" 
                                                    Text='<%# Bind("email") %>' Width="380px" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="LabelCmp5" runat="server" Text="Seus comentários:"></asp:Label>
                                                <br />
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="LabelCmp4" runat="server" Text="Apresentação do Candidato:" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <br />
                                                <asp:Button ID="ButtonCadastra" runat="server" CssClass="button" 
                                                    Text="Cadastrar a indicação" />
                                                <br />
                                                <br />
                                            </td>
                                        </tr>
                    ...
                    <asp:GridView ID="GridViewCliente" runat="server" AllowPaging="True" 
                        ...
                        DataSourceID="SqlEmpresa" Width="100%" ShowHeader="False">
                        <Columns>
                            <asp:BoundField DataField="idCadastroEmpresa" HeaderText="idCadastroEmpresa" 
