<%@ Page Title="" Language="VB" MasterPageFile="~/_gestor/GestorMasterPage.master" AutoEventWireup="false" CodeFile="_infoVaga.aspx.vb" Inherits="_gestor_infoVaga" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <asp:FormView ID="FormViewAnuncio" runat="server" DataKeyNames="idVagaAnuncio" 
                        ...
                        <asp:DetailsView ID="DetailsViewVaga" runat="server" AllowPaging="True" 
                            ...
                            <Fields>
                                ...
                                <asp:TemplateField HeaderText="FormacaoAcademica_Apresenta" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox92" runat="server" 
                                ...
                                <asp:TemplateField HeaderText="Beneficios" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox27" runat="server" CssClass="InputCad" Text='<%# Bind("Beneficios") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Perspectiva" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox29" runat="server" CssClass="InputCad" Text='<%# Bind("Perspectiva") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Perspectiva_Apresenta" ShowHeader="False" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox104" runat="server" 
                                ...
                                <asp:TemplateField HeaderText="FaixaEtariaInicio" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox105" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="FaixaEtariaInicio_Apresenta" ShowHeader="False" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox106" runat="server" 
                                ...
                                <asp:TemplateField HeaderText="FaixaEtariaFim_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox107" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="FaixaEtariaFim" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox108" runat="server" CssClass="InputCad" 
                                            Text='<%# Bind("FaixaEtariaFim") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="FaixaEtariaFim_Apresenta" ShowHeader="False" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox109" runat="server" 
                                ...
                                <asp:TemplateField HeaderText="Sexo_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox110" runat="server" CssClass="InputCad" 
                                            Text='<%# Bind("Sexo_Label") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Sexo" ShowHeader="False" SortExpression="Sexo">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox111" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="Sexo_Apresenta" ShowHeader="False" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox112" runat="server" 
                                            Text='<%# Bind("Sexo_Apresenta") %>'></asp:TextBox>
                                    </InsertItemTemplate>
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListSEXO0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" SelectedValue='<%# Bind("Sexo_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                        </asp:RadioButtonList><br><br>
                                ...
                                <asp:TemplateField HeaderText="ConhecimentoIdioma_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox113" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="ConhecimentoIdioma" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox114" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="ConhecimentoIdioma_Apresenta" ShowHeader="False" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox115" runat="server" 
                                            Text='<%# Bind("ConhecimentoIdioma_Apresenta") %>'></asp:TextBox>
                                    </InsertItemTemplate>
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListIDIOMA0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("ConhecimentoIdioma_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="PerfilComposicaoEquipe_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox116" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="PerfilComposicaoEquipe" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox117" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="PerfilComposicaoEquipe_Apresenta" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox118" runat="server" 
                                            Text='<%# Bind("PerfilComposicaoEquipe_Apresenta") %>'></asp:TextBox>
                                    </InsertItemTemplate>
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListEQUIPE0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("PerfilComposicaoEquipe_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="PerfilGestor_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox119" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="PerfilGestor" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox120" runat="server" CssClass="InputCad" 
                                            Text='<%# Bind("PerfilGestor") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="PerfilGestor_Apresenta" ShowHeader="False" 
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListGESTOR0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("PerfilGestor_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="CursoEspecifico_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox122" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="CursoEspecifico" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox123" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="CursoEspecifico_Apresenta" ShowHeader="False" 
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListCURSO0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("CursoEspecifico_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="Conhecimento_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox125" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="Conhecimento" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox126" runat="server" CssClass="InputCad" 
                                            Text='<%# Bind("Conhecimento") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Conhecimento_Apresenta" ShowHeader="False" 
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListCONHECIMENTO0" runat="server" 
                                            Enabled="False" RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("Conhecimento_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="ConhecimentoInformatica_Label" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox128" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="ConhecimentoInformatica" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox129" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="ConhecimentoInformatica_Apresenta" 
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListINFORMATICA0" runat="server" 
                                            Enabled="False" RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("ConhecimentoInformatica_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="CompetenciaComportamental_Label" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox131" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="CompetenciaComportamental" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox132" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="CompetenciaComportamental_Apresenta" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox133" runat="server" 
                                            Text='<%# Bind("CompetenciaComportamental_Apresenta") %>'></asp:TextBox>
                                    </InsertItemTemplate>
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListCOMPET0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("CompetenciaComportamental_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="CompetenciaProfissional_Label" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox134" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="CompetenciaProfissional" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox135" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="CompetenciaProfissional_Apresenta" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox136" runat="server" 
                                            Text='<%# Bind("CompetenciaProfissional_Apresenta") %>'></asp:TextBox>
                                    </InsertItemTemplate>
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListCOMPETP0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("CompetenciaProfissional_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="AspectoCritico_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox137" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="AspectoCritico" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox138" runat="server" CssClass="InputCad" 
                                            Text='<%# Bind("AspectoCritico") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <InsertItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="AspectoCritico_Apresenta" ShowHeader="False" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox139" runat="server" 
                                ...
                                <asp:TemplateField HeaderText="PrincipalDesafio_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox140" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="PrincipalDesafio" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox141" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="PrincipalDesafio_Apresenta" ShowHeader="False" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox142" runat="server" 
                                ...
                                <asp:TemplateField HeaderText="RelacionamentoInterno_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox143" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="RelacionamentoInterno" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox144" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="RelacionamentoInterno_Apresenta" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox145" runat="server" 
                                            Text='<%# Bind("RelacionamentoInterno_Apresenta") %>'></asp:TextBox>
                                    </InsertItemTemplate>
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListRI0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("RelacionamentoInterno_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="RelacionamentoExterno_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox146" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="RelacionamentoExterno" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox147" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="RelacionamentoExterno_Apresenta" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox148" runat="server" 
                                            Text='<%# Bind("RelacionamentoExterno_Apresenta") %>'></asp:TextBox>
                                    </InsertItemTemplate>
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListRE0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("RelacionamentoExterno_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="infoSobre_viagens_Label" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox149" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="infoSobre_viagens" ShowHeader="False" 
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox150" runat="server" CssClass="InputCad" 
                                ...
                                <asp:TemplateField HeaderText="infoSobre_viagens_Apresenta" ShowHeader="False" 
                                    ...
                                    <InsertItemTemplate>
                                        <asp:TextBox ID="TextBox151" runat="server" 
                                            Text='<%# Bind("infoSobre_viagens_Apresenta") %>'></asp:TextBox>
                                    </InsertItemTemplate>
                                    <ItemTemplate>
                                        <asp:RadioButtonList ID="RadioButtonListIV0" runat="server" Enabled="False" 
                                            RepeatDirection="Horizontal" 
                                            SelectedValue='<%# Bind("infoSobre_viagens_Apresenta") %>'>
                                            <asp:ListItem Value="1">Apresentar</asp:ListItem>
                                            <asp:ListItem Value="0">Não Apresentar</asp:ListItem>
                    ...
                    <ItemTemplate>
                        <table ID="PreViewVaga" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                ...
                                <td align="right">
                                    <asp:ImageButton ID="ImageButtonClose" runat="server" 
                                        ImageUrl="~/images/close.png" onclick="ImageButtonClose_Click" />
                                </td>
                            </tr>
                        </table>
