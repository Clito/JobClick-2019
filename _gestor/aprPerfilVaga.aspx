<%@ Page Title="" Language="VB" MaintainScrollPositionOnPostback="true" MasterPageFile="~/_anonimo/CurriculoPage.master" AutoEventWireup="false" CodeFile="aprPerfilVaga.aspx.vb" Inherits="_anonimo_aprPerfilVaga" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="PanelDocumento" runat="server" BackColor="White">
        ...
        <table ID="RelatorioPerfilVaga" cellpadding="5" cellspacing="5" width="100%">
            <tr>
                <td>
                    <asp:Button ID="Back" runat="server" CssClass="cur01st" Text="Voltar" 
                            ...
                            <table ID="PerfilCandidato1" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="tableFormulario" width="65%">
                                        ...
                                        <asp:Label ID="perfilVagaAprovadoLabel" runat="server" 
                                            Text='<%# Eval("perfil_vaga_aprovado") %>' Visible="False"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" class="tableFormulario" valign="top" width="35%">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="ButtonAprLevantamento" runat="server" CommandName="Update" 
                                    ...
                                    Width="540px" />
                    <asp:Button ID="Back0" runat="server" CssClass="cur01st" Text="Voltar" 
                                    CausesValidation="False" />
                            </td>
                        </tr>
                    </table>
