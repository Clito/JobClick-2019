<%@ Page Title="" Language="VB" MasterPageFile="~/_consultor/ConsultorMasterPage.master" AutoEventWireup="false" CodeFile="_atualizaVaga.aspx.vb" Inherits="_empresa_atualizaVaga" %>
        ...
        <table width="640" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <asp:GridView ID="GridViewVagasPublicadas" runat="server" AllowPaging="True" 
                    ...
                    BorderWidth="1px" DataKeyNames="idVaga,Protocolo,dsfuncao" 
...
&nbsp;<asp:ImageButton ID="ImageButtonC2" runat="server" 
                        ...
                        <asp:HyperLink ID="HyperLinkPreView" runat="server" 
                            NavigateUrl="~/_consultor/previewVaga.aspx">Editar o Anúncio</asp:HyperLink>
...
&nbsp;<asp:Label ID="dsfuncaoLabel" runat="server" Text='<%# Bind("dsfuncao") %>' 
                        ...
                        &nbsp;|
                        <asp:HyperLink ID="HyperLinkPreView" runat="server" 
                            NavigateUrl="~/_open/previewVaga.aspx">Editar o Anúncio</asp:HyperLink>
                    </ItemTemplate>
                </asp:FormView>
                                        <br />
                    <br />
