<%@ Page Title="" Language="VB" validateRequest="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/_consultor/ConsultorMasterPage.master" AutoEventWireup="true" CodeFile="_cadastroLevantamento.aspx.vb" Inherits="_empresa_cadastroLevantamento" %>
            ...
            <tr>
                ...
                <td width="614"><asp:Label ID="LabelCabec" runat="server" CssClass="tituloEmpresa"></asp:Label>
                    ...
                    <asp:ImageButton ID="ImageButtonVaga" runat="server" 
                        ImageUrl="~/images/layoutNew/btCriarVagaLevantamento.png" 
                        ToolTip="Clique aqui para publicar a vaga no painel de oportunidades." 
                        Visible="False" />
                        </td>
            </tr>
        </table>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlListaPerfil" runat="server" 
        ...
        <SelectParameters>
            ...
            <asp:SessionParameter Name="idCadastroEmpresa_Filha" SessionField="idCadastroEmpresaFilha" Type="Int32" />
