<%@ Page Title="" Language="VB" MaintainScrollPositionOnPostback="true" MasterPageFile="~/_empresa/EmpresaPage.master" AutoEventWireup="false" CodeFile="_indica.aspx.vb" Inherits="_gestor_indica" %>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <asp:Label ID="Label52" runat="server" 
                                                    Text="Não existem vagas cadastradas."></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                                    </EmptyDataTemplate>
