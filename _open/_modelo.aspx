...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <br />
            <table border="0" cellpadding="0" cellspacing="0" width="640">
               ...
               <br /><br /> <br />  
        <table id="Modelo" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                        
        <asp:Panel ID="PanelLevantamento" runat="server" Visible="False" Width="500px">
                        ...
                        <asp:GridView ID="GridViewLevantamentoCad" runat="server" 
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="LabelAviso" runat="server" 
                                    Text="Não existem Levantamentos cadastrados no sistema."></asp:Label>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </td>
                </tr>
