<%@ Page Title="" Language="VB" MasterPageFile="~/_parceiro/ParceiroPage.master" AutoEventWireup="false" CodeFile="REL_Empresa.aspx.vb" Inherits="_parceiro_REL_Candidato" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1><asp:Label ID="Label2" runat="server" Text="Relatório de Empresas"></asp:Label></h1>
