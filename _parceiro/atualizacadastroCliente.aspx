<%@ Page Title="" Language="VB" MasterPageFile="~/_parceiro/ParceiroPage.master" AutoEventWireup="false" CodeFile="atualizacadastroCliente.aspx.vb" Inherits="_parceiro_atualizacadastroCliente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1><asp:Label ID="Label2" runat="server" Text="Atualizar Dados de Cliente"></asp:Label></h1>
            ...
            <tr>
                ...
                <asp:Label ID="idUserEmpresaLabel" runat="server" Visible="False"></asp:Label>
                    ...
                    <asp:GridView ID="GridViewCliente" runat="server" AllowPaging="True" 
                        ...
                        BorderWidth="1px" DataKeyNames="idCadastroEmpresa,idParceiro" 
        ...
        <br />
        <br />
        <table width="640" cellpadding="0" cellspacing="0" id="UpDateCadastro">
            <tr>
                <td width="640">
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" valign="bottom">
                                                    ...
                                                    <br />
                                                    <br />
                                                    <asp:ImageButton ID="ImageButtonAtualizar" runat="server" 
                                                        ImageUrl="~/images/layoutNew/btSalvarDadosdaEmpresa.png" />
                                                    <asp:ImageButton ID="ImageButtonCancelar" runat="server" 
                                                        ImageUrl="~/images/layoutNew/btCancelaDadosdaEmpresa.png" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
