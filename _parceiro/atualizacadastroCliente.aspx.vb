...
Partial Class _parceiro_atualizacadastroCliente
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            REM ** ********************************************************************************************************
            REM ** REQUISIÇÃO DE OUTRA PÁGINA (/_parceiro/_infoCliente.aspx?autoTit=Informações%20sobre%20as%20empresas%20cadastradas)
            REM ** ********************************************************************************************************
            If Request.QueryString("idCadastroEmpresa") <> "" Then
                idCadastroEmpresaLabel.Text = Request.QueryString("idParceiro")
                idCadastroEmpresaFilhaLabel.Text = Request.QueryString("idCadastroEmpresa")
    ...
    Sub GetDadosEmpresa()
        ...
        prm.Direction = ParameterDirection.Input
        cmd.Parameters.Add(prm)
        cmd.Parameters("@idParceiro").Value = Session("idCadastroEmpresa")
        ...
        Try
            ...
            If dr.HasRows() Then
                ...
                TextBoxCNPJ.Text = dr("cnpj").ToString
                TextBoxCNPJ.Enabled = False

                nmempresaTextBox.Text = dr("nmempresa").ToString
                nomeResTextBox.Text = dr("nomeRes").ToString

                idUserEmpresaLabel.Text = dr("idUser").ToString

                cepTextBox.Text = dr("cep").ToString

                enderecoTextBox.Text = dr("endereco").ToString

                bairroTextBox.Text = dr("bairro").ToString
                cidadeTextBox.Text = dr("cidade").ToString
                DDUf.SelectedValue = dr("uf").ToString
                ddd.Text = dr("ddd").ToString
                telefone.Text = dr("telefone").ToString

                idAreaAtuacaoDropDownList.SelectedValue = dr("idAreaAtuacao").ToString
                idPorteRadioButtonList.SelectedValue = dr("idPorte").ToString

                Select Case dr("privacidade").ToString
                    Case True
                ...
                tempoexistenciaLabel.Text = dr("tempoexistencia").ToString

                siteTextBox.Text = dr("site").ToString

                userNameTextBox.Text = dr("userName").ToString
                userNameTextBox.Enabled = False
                passwordTextBox.Text = dr("password").ToString
                passwordTextBox.Enabled = False
                fraseTextBox.Text = dr("frase").ToString
    ...
    Protected Sub GridViewCliente_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridViewCliente.SelectedIndexChanged
        ...
        idCadastroEmpresaLabel.Text = GridViewCliente.SelectedDataKey("idParceiro")
    ...
    Protected Sub ImageButtonAtualizar_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles ImageButtonAtualizar.Click
        ...
        prm.Direction = ParameterDirection.Input
        cmd.Parameters.Add(prm)
        cmd.Parameters("@idCadastroEmpresa_Pai").Value = DBNull.Value REM Session("idCadastroEmpresa")
        ...
        Try
            ...
            lblmsn.CssClass = "msnOK"
            lblmsn.Text = "Dados da empresa foram atualizados."
            ImageButtonCancelar.ImageUrl = "~/images/layoutNew/btCancelaDadosdaEmpresaOK.png"
            dr.Close()
