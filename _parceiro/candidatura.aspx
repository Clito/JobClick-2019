<%@ Page Title="" Language="VB" MasterPageFile="~/_parceiro/ParceiroPage.master" AutoEventWireup="false" CodeFile="candidatura.aspx.vb" Inherits="_parceiro_candidatura" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1><asp:Label ID="LabelCabec" runat="server" Text="Candidaturas vindas do site"></asp:Label></h1>
