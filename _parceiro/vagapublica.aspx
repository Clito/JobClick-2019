<%@ Page Language="VB" MasterPageFile="~/_parceiro/ParceiroPage.master" AutoEventWireup="false" CodeFile="vagapublica.aspx.vb" Inherits="_Parceiro_vagapublica" title=":. Sistema JobClick .:" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1><asp:Label ID="Label9" runat="server" Text="Cadastro de Vagas"></asp:Label></h1>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="dsVagaPublicaTextBox" runat="server" CssClass="InputCadEmp" 
                                                    Height="315px" ondatabinding="dsVagaPublicaTextBox_DataBinding" 
    ...
    <asp:SqlDataSource ID="SqlForm" runat="server" 
        ...
        InsertCommand="INSERT INTO tbVagaPublica(idCadastroEmpresa, idfuncao, titVagaPublica, dsVagaPublica, email, data, validade, codigo, referencia, publicar, nroVaga, localTrabalho, UF, pne, idCBOOcupacao) VALUES (@idCadastroEmpresa, @idfuncao, @titVagaPublica, @dsVagaPublica, @email, @data, @validade, @codigo, @referencia, @publicar, @nroVaga, @localTrabalho, @UF, @pne, @idCBOOcupacao)" 
        SelectCommand="SELECT idVagaPublica, idCadastroEmpresa, idfuncao, titVagaPublica, dsVagaPublica, email, data, validade, codigo, referencia, publicar, nroVaga, localTrabalho, UF, ISNULL(idCBOOcupacao,0) AS idCBOOcupacao, pne FROM tbVagaPublica WHERE (idCadastroEmpresa = @idCadastroEmpresa) AND (idVagaPublica = @idVagaPublica)" 
        
        
        
        
        UpdateCommand="UPDATE tbVagaPublica SET idCadastroEmpresa = @idCadastroEmpresa, idfuncao = @idfuncao, titVagaPublica = @titVagaPublica, dsVagaPublica = @dsVagaPublica, email = @email, data = @data, validade = @validade, codigo = @codigo, referencia = @referencia, publicar = @publicar, nroVaga = @nroVaga, localTrabalho = @localTrabalho, UF = @UF, idCBOOcupacao = @idCBOOcupacao, pne = @pne WHERE (idVagaPublica = @idVagaPublica)">
        <SelectParameters>
