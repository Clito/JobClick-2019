<%@ Page Title="" Language="VB" MasterPageFile="~/_parceiroJobClick/parceiroMasterPage.master" AutoEventWireup="false" CodeFile="REL_Candidato.aspx.vb" Inherits="_parceiro_REL_Candidato" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label2" runat="server" Text="Relatório de Candidatos" CssClass="titulo"></asp:Label>
    <asp:Label ID="LabelCabec" runat="server" CssClass="tituloEmpresa"></asp:Label>
                    <br />
    <br />
            <asp:Label ID="Label6" runat="server" Text="Região Selecionada:"></asp:Label>
            <br />
...
"></asp:SqlDataSource>
    <br />
            <br />
                    <asp:Label ID="Label4" runat="server" Text="Candidatos por Área de Atuação:"></asp:Label>
        ...
        BorderWidth="1px" DataSourceID="REL_CandidatoAreaAtuação" 
                        GridLines="Horizontal" CssClass="mGrid" Width="100%">
                        ...
                        <EmptyDataTemplate>
                            <asp:Label ID="Label5" runat="server" Text="Para ver por área de atuação selecione uma região no quadro abaixo."></asp:Label>
                        </EmptyDataTemplate>
                    </asp:GridView>
