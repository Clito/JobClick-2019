<%@ Page Language="VB" MasterPageFile="~/_zoya/zoya.master" AutoEventWireup="false" CodeFile="zoya_profile.aspx.vb" Inherits="_zoya_zoya_profile" title="Untitled Page" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <asp:Label ID="idCadastroUserZoyaLabel" runat="server" Visible="False"></asp:Label>
    <asp:Label ID="idZoyaLabel" runat="server" Visible="False"></asp:Label>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:jobclickDB %>"
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="idZoya" 
            ...
            <EmptyDataTemplate>
                ...
                <asp:FormView ID="FormView2" runat="server" DataKeyNames="idMultimidia" 
                        DataSourceID="SqlMultimidia" CellPadding="0" 
        DefaultMode="Edit" Width="350px" Visible="False">
                    <EditItemTemplate>
        ...
        <asp:SqlDataSource ID="SqlZoyaView" runat="server" 
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="idCadastroUserZoyaLabel" Name="idCadastroUser" 
                    PropertyName="Text" Type="Int32" />
            </SelectParameters>
            <DeleteParameters>
    ...
    <asp:SqlDataSource ID="SqlContato" runat="server" ConnectionString="<%$ ConnectionStrings:jobclickDB %>"
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="idCadastroUserZoyaLabel" DefaultValue="0" 
