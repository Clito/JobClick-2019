<%@ Page Language="VB" MasterPageFile="zoya.master" AutoEventWireup="false" CodeFile="zoyaview.aspx.vb" Inherits="_candidato_zoyaview" title="Untitled Page" %>
                            ...
                            <table cellpadding="0" cellspacing="0" width="465">
                                <tr>
                                    ...
                                    <td width="439">
                                        ...
                                        <asp:DataList ID="DataListDef" runat="server" DataSourceID="SqlDataSource2">
                                            <ItemTemplate>
                                        ...
                                        <asp:Label ID="LabelDf" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
