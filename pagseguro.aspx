<%@ Page Language="VB" MasterPageFile="~/PagSeguroMasterPage.master" AutoEventWireup="true" CodeFile="pagseguro.aspx.vb" Inherits="pagseguro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
            <br />
            <br />
            <asp:Image ID="ImageCANALASSOCIADO" runat="server" ImageUrl="~/images/logoJobClick.png" />
            <br />
            <br />
    ...
    <br />
            ...
            <br />
            <br />
            <asp:Label ID="pesquisaNotificador" runat="server"></asp:Label>
            <br />
            <br />
            <asp:Button ID="ButtonVoltar" runat="server" Text="Voltar para a página principal" CssClass="button" />
            <br />
            <br />
</td></tr></table>    
</asp:Content>
