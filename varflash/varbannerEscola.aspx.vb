...
Partial Class varflash_varbannerEscola
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If HttpContext.Current.User.Identity.Name.ToString <> "RHUser" Then
            StatusLog = "<font color='#499300'><b>Bem-vindo ao sistema JobClick, seu acesso está [liberado] para administrar o programa de estágio.</b></font>"
        Else
        ...
        If Session("nmempresa") <> "" Then
            SNomeEmpresa = "<b>Instituição: </b>" & Session("nmempresa")
        Else
